...
public class Player2 {
    public static void main(String args[]) {
        ...
        while (true) {
            ...
            if (turn == 7) System.out.println("MOVE UP");
            if (turn == 8) System.out.println("PUSH 4 LEFT");
            if (turn == 9) System.out.println("MOVE DOWN LEFT LEFT UP");
            if (turn == 10) System.out.println("PUSH 1 RIGHT");
            if (turn == 11) System.out.println("MOVE DOWN RIGHT");
            if (turn == 12) System.out.println("PUSH 5 RIGHT");
            if (turn == 13) System.out.println("MOVE UP UP UP UP");
            if (turn == 14) System.out.println("PUSH 3 RIGHT");
            if (turn == 15) System.out.println("MOVE DOWN DOWN");
            if (turn == 16) System.out.println("PUSH 3 RIGHT");
            if (turn == 17) System.out.println("MOVE UP UP RIGHT");
            if (turn == 18) System.out.println("PUSH 1 RIGHT");
            if (turn == 19) System.out.println("MOVE UP RIGHT RIGHT DOWN LEFT");
            if (turn == 20) System.out.println("PUSH 1 LEFT");
            if (turn == 21) System.out.println("MOVE DOWN UP UP RIGHT RIGHT DOWN DOWN DOWN");
            if (turn == 22) System.out.println("PUSH 3 LEFT");
            if (turn == 23) System.out.println("MOVE UP UP UP LEFT LEFT DOWN DOWN DOWN");
            if (turn == 24) System.out.println("PUSH 3 LEFT");
            if (turn == 25) System.out.println("MOVE DOWN UP UP");
            if (turn == 26) System.out.println("PUSH 2 LEFT");
            ...
            if (turn == 40) System.out.println("PUSH 3 UP");
